...
namespace Narramancer {
	...
	[CustomNodeEditor(typeof(AreEqualNode))]
	public class AreEqualNodeEditor : ResizableNodeEditor {

		public override bool HasCustomDroppedPortLogic() {
			var targetNode = target as AreEqualNode;
		...
		public override void PerformCustomDroppedPortLogic(Node hoveredNode, NodePort draggedOutput) {
			...
			var targetNode = hoveredNode as AreEqualNode;
